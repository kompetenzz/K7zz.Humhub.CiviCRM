...
class SettingsForm extends CiviCRMSettings
{
    ...
    public function attributeLabels(): array
    {
        return array_merge([
            ...
            'enableBaseSync' => Yii::t('CivicrmModule.config', 'Base Sync'),
            'enableOnChangeSync' => Yii::t('CivicrmModule.config', 'Sync On-Change'),
            'enableOnLoginSync' => Yii::t('CivicrmModule.config', 'Sync On-Login'),
